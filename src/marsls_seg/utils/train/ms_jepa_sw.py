        ...
        params=[
            {
                ...
                "lr": training_config["encoder"]["lr"],
                "weight_decay": training_config["encoder"]["weight_decay"],
            },
            {
                "params": predictor.parameters(),
                "lr": training_config["predictor"]["lr"],
                "weight_decay": training_config["predictor"]["weight_decay"],
            },
        ]
    )
